...
//        getActionBar().setHomeButtonEnabled(true);
   ...
   // mDrawerLayout.setDrawerListener(mDrawerToggle);
    ...
    private void prepareMenu(ArrayList<NavigationItem> mNavItems){
        mNavItems.add(new NavigationItem(getString(R.string.home), getString(R.string.home_long), R.drawable.ic_action_map));
        mNavItems.add(new NavigationItem(getString(R.string.places), getString(R.string.places_long), R.drawable.ic_action_place));
        mNavItems.add(new NavigationItem(getString(R.string.preferences), getString(R.string.preferences_long), R.drawable.ic_action_settings));
        mNavItems.add(new NavigationItem(getString(R.string.about), getString(R.string.about_long), R.drawable.ic_action_about));
        mNavItems.add(new NavigationItem(getString(R.string.sync_data), getString(R.string.sync_data_long), R.drawable.ic_action_refresh));
    }
