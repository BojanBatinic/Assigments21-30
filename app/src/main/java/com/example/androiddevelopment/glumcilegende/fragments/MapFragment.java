...
/**
 * Fragment koji treba da prikaze mapu, treba i da implementira i OnMapReadyCallback
...
public class MapFragment extends Fragment implements LocationListener, OnMapReadyCallback {
     ...
     * po kom kriterijumu zelimo da dobijamo informacije GSP, MOBILNI(WIFI, Mobilni internet), GPS+MOBILNI
     **/
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        map.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragEnd(Marker marker) {
                Toast.makeText(getActivity(), "Drag end", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    /**
     *
     * Rad sa lokacijama izuzetno trosi bateriju. Obavezno osloboditi resurse kada ih vise ne koristimo
     * */
    @Override
    public void onPause(){
        super.onPause();
